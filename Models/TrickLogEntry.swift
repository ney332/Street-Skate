...
enum TrickLogStatus: String, Codable, CaseIterable {
    ...
    var localizedName: String {
        switch self {
        case .landed: return "trick.status.landed".localized
        case .almost: return "trick.status.almost".localized
        case .learning: return "trick.status.learning".localized
        case .firstTime: return "trick.status.first_time".localized
        }
    }
}
