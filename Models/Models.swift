...
enum SkaterLevel: String, Codable, CaseIterable {
    ...
    var localizedName: String {
        switch self {
        case .amateur: return "level.amateur.name".localized
        case .intermediate: return "level.intermediate.name".localized
        case .professional: return "level.professional.name".localized
        }
    }
    
    var description: String {
        switch self {
        case .amateur: return "level.amateur.description".localized
        case .intermediate: return "level.intermediate.description".localized
        case .professional: return "level.professional.description".localized
        }
    }
...
enum TrickDifficulty: String, Codable, CaseIterable {
    ...
    var color: String {
        switch self {
        case .beginner: return "#FFFFFF"
        case .intermediate: return "#FFFFFF"
        case .advanced: return "#FFFFFF"
...
enum TrickCategory: String, Codable, CaseIterable {
    ...
    var localizedName: String {
        switch self {
        case .flatground: return "category.flatground".localized
        case .grinds: return "category.grinds".localized
        case .flips: return "category.flips".localized
        case .airs: return "category.airs".localized
        case .manuals: return "category.manuals".localized
        }
    }
}
...
struct SkateSpot: Identifiable {
    ...
    var distanceText: String {
        if distanceMeters < 1000 {
            return "spot.distance.meters".localized(Int(distanceMeters))
        } else {
            return "spot.distance.kilometers".localized(distanceMeters / 1000)
        }
    }
}
...
enum SpotType: String {
    ...
    var localizedName: String {
        switch self {
        case .plaza: return "spot.type.plaza".localized
        case .park: return "spot.type.park".localized
        case .street: return "spot.type.street".localized
        case .bowl: return "spot.type.bowl".localized
        case .diy: return "spot.type.diy".localized
        }
    }
...
extension SkateTrick {
    static let allTricks: [SkateTrick] = [
        // Flat Ground
        SkateTrick(name: "Any Trick", difficulty: .beginner, category: .flatground, xpReward: 0, description: ""),
