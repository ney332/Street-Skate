...
struct SpotDetailView: View {
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        HStack(alignment: .top) {
                            VStack(alignment: .leading, spacing: 6) {
                                ...
                                HStack(spacing: 10) {
                                    Label(spot.type.localizedName, systemImage: spot.type.icon)
                        ...
                        HStack(spacing: 12) {
                            ...
                            SpotStatPill(icon: "skateboard", text: spot.type.localizedName)
                        }
    ...
    func shareSpot() {
        let text = "spot.share.text".localized(spot.name, spot.distanceText)
