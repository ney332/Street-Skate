...
struct SkateDrawView: View {
        ...
        ScrollView {
            VStack(spacing: 28) {
                ...
                VStack(spacing: 6) {
                    ...
                    Text("game.skate.subtitle".localized)
                ...
                VStack(spacing: 0) {
                    HStack {
                        Text("game.skate.players".localized)
                        ...
                        if players.count < maxPlayers {
                            Button(action: addPlayer) {
                                HStack(spacing: 8) {
                                    ...
                                    Text("game.skate.add_player".localized)
                ...
                Button(action: startDraw) {
                    HStack(spacing: 10) {
                        ...
                        Text("game.skate.draw".localized)
    ...
    func playerRow(index: Int) -> some View {
        HStack(spacing: 12) {
            ...
            TextField("game.skate.player.placeholder".localized(index + 1), text: $players[index])
    ...
    var spinningView: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 32) {
                ...
                Text("game.skate.drawing".localized)
    ...
    var resultView: some View {
        ScrollView {
            VStack(spacing: 20) {
                ...
                // Winner card
                VStack(spacing: 16) {
                    Text("game.skate.starts".localized)
                        .font(.system(size: 11, weight: .semibold, design: .rounded))
                        .foregroundColor(textSecondary)
                        .kerning(3)
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("game.skate.trick".localized)
                            .font(.system(size: 11, weight: .semibold, design: .rounded))
                            .foregroundColor(textSecondary)
                            .kerning(2)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    Text("game.skate.order".localized)
                        .font(.system(size: 11, weight: .semibold, design: .rounded))
                        .foregroundColor(textSecondary)
                        .kerning(2)
                        .padding(.horizontal, 4)
                ...
                VStack(spacing: 10) {
                    Button(action: reshuffleDraw) {
                        HStack(spacing: 8) {
                            ...
                            Text("game.skate.draw_again".localized)
                    ...
                    Button(action: backToSetup) {
                        HStack(spacing: 8) {
                            Image(systemName: "person.2.fill")
                                .font(.system(size: 14))
                            Text("game.skate.edit_players".localized)
    ...
    func orderRow(position: Int, name: String) -> some View {
        HStack(spacing: 14) {
            ...
            if position == 1 {
                Text("game.skate.goes_first".localized)
                    .font(.system(size: 11, weight: .semibold, design: .rounded))
                    .foregroundColor(neon)
