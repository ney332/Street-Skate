...
class NotificationService {
    ...
    func scheduleDailyReminder(hour: Int = 17, minute: Int = 0) {
        ...
        let messages = [
            "notification.daily.message.1".localized,
            "notification.daily.message.2".localized,
            "notification.daily.message.3".localized,
            "notification.daily.message.4".localized,
            "notification.daily.message.5".localized,
        ]
    ...
    func sendAchievementNotification(title: String, description: String) {
        let content = UNMutableNotificationContent()
        content.title = "notification.achievement.title".localized
        content.body = "notification.achievement.body".localized(title, description)
    ...
    func sendMilestoneNotification(km: Double) {
        ...
        content.body = "notification.milestone.body".localized(km)
        content.sound = .default
    ...
    func scheduleStreakWarning() {
        ...
        let content = UNMutableNotificationContent()
        content.title = "notification.streak.title".localized
        content.body = "notification.streak.body".localized
        content.sound = .default
